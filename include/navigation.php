...
<nav id="mainNav" class="navbar fixed-top navbar-default navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="./index.php"><span style="font-weight: bold; color: crimson;">
  &#x1FA78;</span> DONATETHEBLOOD</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav form-inline my-2 my-lg-0">
      ...
      <?php if(isset($_SESSION['user_id']) || isset($_SESSION['donor_id'])): ?>
      <li class="nav-item">
