            ...
            <div class="panel">
                ...
                <?php
                    ...
                    <div class="text-center">
                        <button  name="date" id="save_the_life" type="submit" class="btn btn-lg  btn-danger center-aliged">Save The Life</button>
                    </div>
                    </form>';
                       ...
                       if($diffMonth >=3){
                         echo ' <form target="" method="post">
                    <div class="text-center">
                        <button  name="date" id="save_the_life" type="submit" class="btn btn-danger">Save The Life</button>
                    </div>
                    </form>';
                    ...
                    <span> You already saved a life. You can donate blood again after three months. Thank you!
                    </span>
                    </div>';
                     }
